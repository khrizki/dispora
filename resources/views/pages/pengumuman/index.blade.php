                    ...
                    <div class="card-header pt-2">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="{{ route('pages.pengumuman.create') }}" class="btn fw-bold btn-primary">Add</a>
                            </div>
                        </div>
                    </div>
        ...
        const KTDatatablesServerSide = function() {
            ...
            const initDatatable = function() {
                table = new DataTable('#dataTableDokumen', {
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('pages.pengumuman.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                    ...
                    columnDefs: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            let editRoute = "{{ route('pages.pengumuman.edit', ':id') }}";
                            editRoute = editRoute.replace(':id', row.id);
                            let deleteUrl = "{{ route('pages.pengumuman.destroy', ':id') }}"
                                .replace(':id',
                                    row.id);
