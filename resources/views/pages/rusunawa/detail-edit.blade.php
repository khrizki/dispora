...
@section('title', 'Edit Detail Rusunawa')
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Edit Detail Rusunawa: {{ $rusunawa->nama }}
                    </h1>
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body py-4">
                        <form action="{{ route('pages.rusunawa.detail.update', $rusunawa->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="kode" class="form-control form-control-solid" 
                                                value="{{ old('kode', $detail->kode) }}" placeholder="Contoh: 128">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="uprs" class="form-control form-control-solid" 
                                                value="{{ old('uprs', $detail->uprs) }}" placeholder="Contoh: UPRS VIII">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="kepala_uprs" class="form-control form-control-solid" 
                                                value="{{ old('kepala_uprs', $detail->kepala_uprs) }}" placeholder="Nama Kepala UPRS">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" name="luas_area_m2" class="form-control form-control-solid" 
                                                value="{{ old('luas_area_m2', $detail->luas_area_m2) }}" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nomor_imb" class="form-control form-control-solid" 
                                                value="{{ old('nomor_imb', $detail->nomor_imb) }}" placeholder="Nomor IMB">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nomor_slf" class="form-control form-control-solid" 
                                                value="{{ old('nomor_slf', $detail->nomor_slf) }}" placeholder="Nomor SLF">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" name="dana_pembangunan" class="form-control form-control-solid" 
                                                value="{{ old('dana_pembangunan', $detail->dana_pembangunan) }}" placeholder="0">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="status_serah_terima" class="form-select form-select-solid">
                                                <option value="Belum" {{ old('status_serah_terima', $detail->status_serah_terima) == 'Belum' ? 'selected' : '' }}>Belum</option>
                                                <option value="Sudah" {{ old('status_serah_terima', $detail->status_serah_terima) == 'Sudah' ? 'selected' : '' }}>Sudah</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="tahun_pembuatan" class="form-control form-control-solid" 
                                                value="{{ old('tahun_pembuatan', $detail->tahun_pembuatan) }}" placeholder="Contoh: 2017 - 2018">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.01" name="tarif_unit_terprogram" class="form-control form-control-solid" 
                                                value="{{ old('tarif_unit_terprogram', $detail->tarif_unit_terprogram) }}" placeholder="505000">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.01" name="tarif_unit_umum" class="form-control form-control-solid" 
                                                value="{{ old('tarif_unit_umum', $detail->tarif_unit_umum) }}" placeholder="765000">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.01" name="batas_maksimum_gaji" class="form-control form-control-solid" 
                                                value="{{ old('batas_maksimum_gaji', $detail->batas_maksimum_gaji) }}" placeholder="7000000">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="kelurahan" class="form-control form-control-solid" 
                                                value="{{ old('kelurahan', $detail->kelurahan) }}" placeholder="Kelurahan">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="kecamatan" class="form-control form-control-solid" 
                                                value="{{ old('kecamatan', $detail->kecamatan) }}" placeholder="Kecamatan">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="kota_kabupaten" class="form-control form-control-solid" 
                                                value="{{ old('kota_kabupaten', $detail->kota_kabupaten) }}" placeholder="Kota/Kabupaten">
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="embed_gmaps_url" class="form-control form-control-solid" rows="3" 
                                                placeholder="Paste link embed Google Maps disini">{{ old('embed_gmaps_url', $detail->embed_gmaps_url) }}</textarea>
                            ...
                            <div class="card shadow-sm mb-5">
                                ...
                                <div class="card-body">
                                    <div id="fasilitas-container">
                                        @php
                                            $fasilitasData = old('fasilitas', $detail->fasilitas ?? []);
                                        @endphp
                                        @if(count($fasilitasData) > 0)
                                            @foreach($fasilitasData as $index => $fasilitas)
                                                <div class="row g-3 fasilitas-row">
                                                    <div class="col-md-5">
                                                        <input type="text" name="fasilitas[{{ $index }}][nama]" class="form-control form-control-solid" 
                                                            placeholder="Nama Fasilitas" value="{{ $fasilitas['nama'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <input type="number" name="fasilitas[{{ $index }}][jumlah]" class="form-control form-control-solid" 
                                                            placeholder="Jumlah" value="{{ $fasilitas['jumlah'] ?? 1 }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" name="fasilitas[{{ $index }}][keterangan]" class="form-control form-control-solid" 
                                                            placeholder="Keterangan" value="{{ $fasilitas['keterangan'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-1">
                            ...
                            <div class="card shadow-sm mb-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Input untuk hapus foto -->
                                    <input type="hidden" name="hapus_foto_array" id="hapus_foto_array" value="">

                                    <!-- Upload foto baru -->
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <label class="form-label fw-semibold">Upload Foto Baru (Multiple)</label>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <textarea name="deskripsi" class="form-control form-control-solid" rows="5" 
                                                placeholder="Deskripsi detail tentang rusunawa">{{ old('deskripsi', $detail->deskripsi) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('script')
    <script>
        let fasilitasIndex = {{ count($detail->fasilitas ?? []) }};
        let deletedPhotos = [];
        ...
        function deleteFoto(index) {
            if (confirm('Yakin ingin menghapus foto ini?')) {
                deletedPhotos.push(index);
                $('#hapus_foto_array').val(JSON.stringify(deletedPhotos));
                $(`.preview-image[data-index="${index}"]`).fadeOut(300, function() {
                    $(this).remove();
                });
            }
        }
