                    ...
                    <div class="card-header pt-2">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="{{ route('pages.galeri.create') }}" class="btn fw-bold btn-primary">Add</a>
                            </div>
                        </div>
                    </div>
                ...
                table = new DataTable('#dataTableGaleri', {
                    ...
                    columnDefs: [{
                        ...
                        render: function(data, type, row) {
                            let editRoute = "{{ route('pages.galeri.edit', ':id') }}";
                            editRoute = editRoute.replace(':id', row.id);
                            let deleteUrl = "{{ route('pages.galeri.destroy', ':id') }}"
                                .replace(':id', row.id);
