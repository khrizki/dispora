...
@section('title', 'Berita Bpkad Kota Padang')
                    ...
                    <div class="card-header pt-2">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="{{ route('pages.berita.create') }}" class="btn fw-bold btn-primary">Add</a>
                            </div>
                        </div>
                    </div>
                ...
                table = new DataTable('#dataTableDokumen', {
                    ...
                    columnDefs: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            let editRoute = "{{ route('pages.berita.edit', ':id') }}".replace(
                                ':id',
                                row
                                .id);
                            let deleteUrl = "{{ route('pages.berita.destroy', ':id') }}"
                                .replace(':id',
                                    row.id);
            ...
            if (confirm('Yakin ingin menghapus data ini?')) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#dataTableDokumen').DataTable().ajax.reload(); // reload table
                    },
                    error: function(xhr) {
