        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                <div class="card-body py-4">
                    <form action="{{ route('pages.video.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body row">
                                <div class="col-md-6 mb-5">
                                    ...
                                    <input type="text" name="judul_video" value="{{ old('judul_video') }}"
                                        class="form-control form-control-solid" placeholder="Masukkan Judul Video"
                                        required>
                                </div>
                                <div class="col-md-6 mb-5">
                                    <label class="form-label fw-semibold">Link Video YouTube</label>
                                    <input type="text" name="video" value="{{ old('video') }}"
                                        class="form-control form-control-solid" placeholder="Masukkan URL YouTube">
                                </div>
                            </div>
                        </div>
