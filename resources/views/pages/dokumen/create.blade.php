            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Tambah Data Regulasi / Peraturan
                    </h1>
                </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-body py-4">
                        <form action="{{ route('pages.dokumen.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card shadow-sm mb-5">

                                <div class="card-body row">
                                    <div class="col-md-6 mb-5">
                                        <label class="form-label fw-semibold">Judul Regulasi / Peraturan</label>
                                    ...
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <input type="date" name="tanggal" value="{{ old('tanggal') }}"
                                            class="form-control form-control-solid" placeholder="Masukkan Tanggal" required>
                                    </div>
                                    <div class="col-md-6 mb-5">
                                        <label class="form-label fw-semibold">Upload File Regulasi / Peraturan</label>
