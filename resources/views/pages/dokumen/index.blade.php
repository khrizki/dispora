...
@section('title', 'Regulasi / Peraturan')
                ...
                table = new DataTable('#dataTableDokumen', {
                    ...
                    columnDefs: [{
                        ...
                        render: function(data, type, row) {
                            ...
                            let routeEdit = "{{ route('pages.dokumen.edit', ':id') }}".replace(
                                ':id', row.id);
                            let deleteUrl = "{{ route('pages.dokumen.destroy', ':id') }}"
                                .replace(':id',
                                    row.id);
                            ...
                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                     ...
                                     <div class="menu-item px-3">
                                        <a href="${routeEdit}" class="menu-link px-3" data-kt-docs-table-filter="edit_row">Edit</a>
                                    </div>
                                    <div class="menu-item px-3">
