                        ...
                        <div class="card shadow-sm mb-5">
                            <div class="row g-5">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="judul" class="form-control form-control-solid" required>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="lokasi" class="form-control form-control-solid" placeholder="Contoh: Padang / Dinas PERKIM Kota Padang">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="deskripsi" class="form-control form-control-solid" rows="6" required placeholder="Tulis detail lowongan..."></textarea>
                                </div>
