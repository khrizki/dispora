                    ...
                    <div class="card-header pt-2">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="{{ route('pages.lowongan.create') }}" class="btn fw-bold btn-primary">Add</a>
                            </div>
                        </div>
                    </div>

                    <div class="card-body py-4">
                        <table id="dataTableLowongan" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 
                                ...
                                <div class="menu-item px-3">
                                    <a href="${deleteUrl}" class="menu-link px-3" data-delete-row>Delete</a>
                                </div>
                            </div>
                        `;
                    },
