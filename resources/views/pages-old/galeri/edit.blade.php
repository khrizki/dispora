...
@section('content')
    ...
    <div class="col-12">
        <form action="{{ route('galeri.update', $data->id) }}" method="post" class="card" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-body">
                <div class="row row-cards">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="row flex mb-3">
                            ...
                            <div class="col-auto">
                                <a href="#" class="btn btn-icon btn-{{ $data->gambar != null ? 'detail' : 'preview' }}"
                                    data-file="{{ asset($data->gambar) }}" aria-label="Button">
