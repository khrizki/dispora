            ...
            table = new DataTable('#dataTableKerjasama', {
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, row) {
                        let editRoute = "{{ route('admin.kerja-sama.edit', ':id') }}".replace(':id', row.id);
                        let deleteUrl = "{{ route('admin.kerja-sama.destroy', ':id') }}".replace(':id', row.id);

                        return `
                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm"
                               data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                               Actions <i class="fa fa-angle-down ms-2"></i>
                            </a>
