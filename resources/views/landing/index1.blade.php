...
<body onload="slider()">
    ...
    <style>
        ...
        .card-animation-delay-1 { animation-delay: 0.2s; }
        .card-animation-delay-2 { animation-delay: 0.4s; }
        .card-animation-delay-3 { animation-delay: 0.6s; }
        .card-animation-delay-4 { animation-delay: 0.8s; }
        .image-animation-delay { animation-delay: 1s; }
    ...
    <div class="page-home">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block bg-100" src="{{ asset('assets/img/intersect.png') }}" id="slideImg" alt="First slide">
        ...
        <section class="py-5" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);" id="transformasi">
            <div class="container">
                <div class="row text-center mb-5">
                    <div class="col-12">
                        ...
                        <p class="text-muted">Lihat perubahan sebelum dan sesudah program PERKIM</p>
                    </div>
                </div>
                            ...
                            <div class="before-after-wrapper">
                                <div class="before-after-carousel">
                                    @foreach($infoBergambar as $index => $item)
                                        <div class="before-after-item {{ $index == 0 ? 'active' : '' }}" data-index="{{ $index }}">
                                            <div class="before-after-slider">
                                                ...
                                                <div class="before-after-info">
                                                    ...
                                                    <small><i class="bi bi-calendar3"></i> {{ \Carbon\Carbon::parse($item->created_at)->format('d M Y') }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="profile-card">
                            <div class="profile-card-content">
                                @if($pejabat)
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('profil.sambutan') }}" class="btn btn-light btn-lg px-4 shadow">
                                            <i class="bi bi-arrow-right-circle me-2"></i> Baca Selengkapnya
                                        </a>
                                    </div>
                                @else
                                    <div class="profile-name">Kepala Dinas PERKIM</div>
                ...
                <div class="row justify-content-center mt-4">
                    ...
                    <div class="col-md-3 col-6 mb-3">
                        <a href="https://sirumahkita.padang.go.id/" class="text-decoration-none">
                            <div class="card shadow-sm border-0 p-3 hover-scale">
                                <img src="{{ asset('assets/img/logo.png') }}" class="img-fluid mb-2" alt="SIRUMAHKITA">
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-12 mt-5">
                        ...
                        <p>Galeri dan Dokumentasi Kegiatan <span class="badge bg-warning text-dark">PERKIM</span> Kota Padang</p>
                        <hr class="line">
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-12 mt-5">
                        ...
                        <p>Jumlah Pengunjung Website <span class="badge bg-warning text-dark">PERKIM</span> Kota Padang</p>
                        <hr class="line">
                    </div>
                </div>
